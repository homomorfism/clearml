...
class AddOrUpdateMetadataRequest(Request):
    ...
    def __init__(self, model, metadata, replace_metadata=False, **kwargs):
...
class DeleteResponse(Response):
    ...
    def __init__(self, deleted=None, url=None, **kwargs):
...
class DeleteManyRequest(Request):
    ...
    def __init__(self, ids, force=None, **kwargs):
...
class GetAllResponse(Response):
    ...
    def __init__(self, models=None, scroll_id=None, **kwargs):
...
class GetFrameworksResponse(Response):
    ...
    def __init__(self, frameworks=None, **kwargs):
...
class PublishManyRequest(Request):
    ...
    _schema = {
        ...
        "properties": {
            ...
            "publish_tasks": {
                "description": (
                    "Indicates that the associated tasks (if exist) should be published. Optional, the default value "
                    "is True."
                ),
                "type": "boolean",
            },
    ...
    def __init__(self, ids, force_publish_task=None, publish_tasks=None, **kwargs):
            ...
            "succeeded": {
                "items": {
                    "properties": {
                        ...
                        "published_task": {
                            "description": (
                                "Result of publishing of the model's associated task (if exists). Returned only if the"
                                " task was published successfully as part of the model publishing."
                            ),
                            "properties": {
                                "data": {
...
class SetReadyRequest(Request):
    ...
    _schema = {
        ...
        "properties": {
            ...
            "publish_task": {
                "description": (
                    "Indicates that the associated task (if exists) should be published. Optional, the "
